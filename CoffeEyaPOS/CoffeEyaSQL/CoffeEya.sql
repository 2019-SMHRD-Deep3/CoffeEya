...
Insert into CUSTOMER (CUS_NUMBER,CUS_NAME,CUS_PHONE,CUS_SEX,CUS_BIRTHDAY,CUS_POINT) values (7004,'윤지혜','010-8487-4564','FEMALE',to_date('90/02/09','RR/MM/DD'),15);
Insert into CUSTOMER (CUS_NUMBER,CUS_NAME,CUS_PHONE,CUS_SEX,CUS_BIRTHDAY,CUS_POINT) values (7005,'강혜성','010-4644-4852','FEMALE',to_date('98/08/17','RR/MM/DD'),816);
Insert into CUSTOMER (CUS_NUMBER,CUS_NAME,CUS_PHONE,CUS_SEX,CUS_BIRTHDAY,CUS_POINT) values (7006,'이재원','010-3628-4491','FEMALE',to_date('99/11/06','RR/MM/DD'),1315);
Insert into CUSTOMER (CUS_NUMBER,CUS_NAME,CUS_PHONE,CUS_SEX,CUS_BIRTHDAY,CUS_POINT) values (7007,'김인우','010-5496-8125','MALE',to_date('00/07/08','RR/MM/DD'),2318);
Insert into CUSTOMER (CUS_NUMBER,CUS_NAME,CUS_PHONE,CUS_SEX,CUS_BIRTHDAY,CUS_POINT) values (7008,'유지윤','010-8486-1138','MALE',to_date('00/02/12','RR/MM/DD'),1542);
