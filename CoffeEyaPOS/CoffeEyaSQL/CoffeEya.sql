...
Insert into MEMBER (MEM_ID,MEM_PW,MEM_NAME,MEM_PERM) values ('1111','1111','오원일','manager');
...
Insert into MEMBER (MEM_ID,MEM_PW,MEM_NAME,MEM_PERM) values ('오원일','1111','오원일','manager');
--------------------------------------------------------
...
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (3,to_date('20/01/02','RR/MM/DD'),'현금',9500,'1111');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (4,to_date('20/01/02','RR/MM/DD'),'카드',18000,'1111');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (5,to_date('20/01/03','RR/MM/DD'),'현금',22000,'1111');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (6,to_date('20/01/03','RR/MM/DD'),'현금',22000,'5555');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (7,to_date('20/01/03','RR/MM/DD'),'카드',18000,'5555');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (8,to_date('20/01/04','RR/MM/DD'),'현금',4000,'5555');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (9,to_date('20/01/04','RR/MM/DD'),'카드',6000,'5555');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (10,to_date('20/01/04','RR/MM/DD'),'카드',10000,'5555');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (11,to_date('20/01/04','RR/MM/DD'),'현금',9500,'5555');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (12,to_date('20/01/04','RR/MM/DD'),'카드',18000,'6666');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (13,to_date('20/01/05','RR/MM/DD'),'현금',22000,'6666');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (14,to_date('20/01/05','RR/MM/DD'),'카드',22000,'6666');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (15,to_date('20/01/05','RR/MM/DD'),'현금',18000,'6666');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (16,to_date('20/01/06','RR/MM/DD'),'현금',4000,'6666');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (17,to_date('20/01/06','RR/MM/DD'),'카드',6000,'6666');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (18,to_date('20/01/06','RR/MM/DD'),'카드',10000,'6666');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (19,to_date('20/01/06','RR/MM/DD'),'현금',9500,'6666');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (20,to_date('20/01/07','RR/MM/DD'),'현금',18000,'6666');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (21,to_date('20/01/07','RR/MM/DD'),'현금',22000,'2222');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (22,to_date('20/01/07','RR/MM/DD'),'카드',22000,'2222');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (23,to_date('20/01/07','RR/MM/DD'),'카드',18000,'2222');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (24,to_date('20/01/07','RR/MM/DD'),'카드',4000,'2222');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (25,to_date('20/01/07','RR/MM/DD'),'카드',6000,'2222');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (26,to_date('20/01/08','RR/MM/DD'),'카드',10000,'2222');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (27,to_date('20/01/08','RR/MM/DD'),'현금',9500,'2222');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (28,to_date('20/01/08','RR/MM/DD'),'현금',18000,'2222');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (29,to_date('20/01/08','RR/MM/DD'),'카드',22000,'7777');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (30,to_date('20/01/08','RR/MM/DD'),'카드',22000,'7777');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (31,to_date('20/01/08','RR/MM/DD'),'카드',8000,'7777');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (32,to_date('20/01/08','RR/MM/DD'),'현금',4000,'7777');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (33,to_date('20/01/08','RR/MM/DD'),'카드',6000,'7777');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (34,to_date('20/01/09','RR/MM/DD'),'카드',10000,'7777');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (35,to_date('20/01/09','RR/MM/DD'),'현금',9500,'7777');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (36,to_date('20/01/09','RR/MM/DD'),'카드',18000,'3333');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (37,to_date('20/01/09','RR/MM/DD'),'카드',22000,'3333');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (38,to_date('20/01/09','RR/MM/DD'),'현금',22000,'3333');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (39,to_date('20/01/09','RR/MM/DD'),'카드',18000,'3333');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (40,to_date('20/01/09','RR/MM/DD'),'현금',4000,'3333');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (41,to_date('20/01/10','RR/MM/DD'),'카드',6000,'3333');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (42,to_date('20/01/10','RR/MM/DD'),'카드',10000,'3333');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (43,to_date('20/01/10','RR/MM/DD'),'현금',9500,'3333');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (44,to_date('20/01/10','RR/MM/DD'),'카드',18000,'3333');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (45,to_date('20/01/04','RR/MM/DD'),'카드',22000,'4444');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (46,to_date('20/01/10','RR/MM/DD'),'현금',22000,'4444');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (47,to_date('20/01/11','RR/MM/DD'),'현금',18000,'4444');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (48,to_date('20/01/11','RR/MM/DD'),'현금',4000,'4444');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (49,to_date('20/01/11','RR/MM/DD'),'카드',6000,'4444');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (50,to_date('20/01/11','RR/MM/DD'),'카드',10000,'4444');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (51,to_date('20/01/12','RR/MM/DD'),'카드',9500,'4444');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (52,to_date('20/01/12','RR/MM/DD'),'카드',18000,'4444');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (53,to_date('20/01/12','RR/MM/DD'),'카드',22000,'4444');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (54,to_date('20/01/12','RR/MM/DD'),'현금',22000,'4444');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (55,to_date('20/01/12','RR/MM/DD'),'카드',18000,'4444');
Insert into ORDERING (OR_NUM,OR_DATE,OR_PAY,OR_SUM,MEM_ID) values (56,to_date('20/01/12','RR/MM/DD'),'현금',4000,'4444');
------------------------------------------------------
